...
18 data files total; chose 5 data sets that summed daily totals. In all 5 data sets, I ensured/manipulated the date into yyyy-mm-dd format to work easier with in R, and split time stamps into their own columns.
...
```{r}
# ggplot of daily mean HR per session id with color palette
heartrates_vis1 %>% 
  ggplot(aes(x = date, y = meanhr, color = factor(id))) +
  geom_point() +
